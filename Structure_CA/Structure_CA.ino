...
void loop() {
  ...
  for (int y = 0; y < HEIGHT; y++) {
    ...
    for (int x = 0; x < WIDTH; x++) {
      ...
      if(state[x] == 1) coll = BLUE;
      if(state[x] == 2) coll = RED;
      if(state[x] == 3) coll = GREEN;
      if(state[x] == 4) coll = CYAN;
      if(state[x] == 5) coll = MAGENTA;
      if(state[x] == 6) coll = YELLOW;
      if(state[x] == 7) coll = BLUE;
      if(state[x] == 8) coll = RED;
      if(state[x] == 9) coll = GREEN;
      if(state[x] == 10) coll = CYAN;
      if(state[x] == 11) coll = MAGENTA;
      if(state[x] == 12) coll = YELLOW;
      if(state[x] == 13) coll = BLUE;
      if(state[x] == 14) coll = RED;
      if(state[x] == 15) coll = WHITE;
