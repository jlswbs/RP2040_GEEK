...
void loop() {
  ...
  for (int i = 0; i < ITER; i++) {
    ...
    switch(current_col){
      case 0: col[oldposx + oldposy * WIDTH] = RED; break;
      case 1: col[oldposx + oldposy * WIDTH] = GREEN; break;
      case 2: col[oldposx + oldposy * WIDTH] = BLUE; break;
      case 3: col[oldposx + oldposy * WIDTH] = WHITE; break;
    }
